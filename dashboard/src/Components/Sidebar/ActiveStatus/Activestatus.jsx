...
const Activestatus = () => {
  ...
  return (
    ...
    <Card  className='status_head'>
        ...
        <Row >
            <Col>
      <Card style={{ width: "145px", height: "140px" ,marginTop:"5px",borderRadius:"15px",marginLeft:"5px",backgroundColor:"white"}}>
      ...
      <Col>
      <Card style={{ width: "110px", height: "140px",marginLeft:"-20px",borderRadius:"15px",marginTop:"5px",backgroundColor:"white" }}>
        <div>
