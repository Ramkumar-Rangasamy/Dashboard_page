...
<div className='campaign_ads_container col-md-4'>
    ...
    <div className='campaign_amt_ads_container  d-flex '>
    ...
    <small className=' text-dark spent_text'>Spent This Month</small>
    ...
    <div className='adss'>
      <div className='adsss' style={{ position: "relative", width: "110px", height: "235px", marginLeft: "15px" }}>
        ...
        <div style={{ color:"black" }} >
            ...
            <span  style={{ position:"absolute",top:"65px",fontSize:"7px",left:"20px",fontWeight:"15px",color:"black" }} > vs previous 30 day</span>
            ...
            <span  style={{ position:"absolute",top:"145px",fontSize:"7px",left:"20px",fontWeight:"15px", color:"black"}} >vs previous 30 day</span>
            <span  style={{ position:"absolute",top:"160px",fontSize:"8px",left:"10px", color:"black"}} >Email Blocked</span>
            <span  style={{ position:"absolute",top:"200px",left:"45px",fontSize:"15px",fontWeight:"25px", color:"black"}} >0</span>
            <span  style={{ position:"absolute",top:"220px",fontSize:"7px",left:"20px",fontWeight:"15px", color:"black"}} >vs previous 30 day</span>
